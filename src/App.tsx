...
const PAYFAST_CONFIG = {
  ...
  action_url: import.meta.env.VITE_PAYFAST_URL || 'https://sandbox.payfast.co.za/eng/process',
...
// 1. Install SDK: npm install @yoco/sdk (or use script tag)
// 2. Replace PayFast logic in CheckoutModal with Yoco.showPopup()
const YOCO_CONFIG = {
  publicKey: import.meta.env.VITE_YOCO_PUBLIC_KEY || 'pk_test_ed3c54a6gOol69qa7f45', // Test key
};
...
const CheckoutModal = ({ product, size, onClose }: { product: typeof PRODUCT; size: string; onClose: () => void }) => {
  ...
  const handleYocoPayment = () => {
    // This is where Yoco integration will go
    // See: https://developer.yoco.com/online/web/inline-checkout
    alert("Yoco integration placeholder. Implementation details in src/App.tsx");
  };
          ...
          {step === 2 && (
            ...
            >
              ...
              <button
                ...
                className="w-full py-4 bg-gray-800 text-white font-bold rounded-xl hover:bg-gray-700 transition-all disabled:opacity-50 disabled:cursor-not-allowed border border-gray-700"
              >
                {isProcessing ? (
