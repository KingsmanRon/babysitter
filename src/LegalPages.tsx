      ...
      >
        ...
        >
          <div className="flex items-center justify-between p-6 border-b border-gray-800">
            ...
            <button onClick={onClose} aria-label="Close" className="w-8 h-8 rounded-full bg-gray-800 flex items-center justify-center text-gray-400 hover:text-white transition-colors">
              <X className="w-4 h-4" />
            </button>
          </div>
          ...
          <div className="flex-1 overflow-y-auto p-6 space-y-6 text-gray-300 text-sm leading-relaxed">
            ...
            <section>
              ...
              <p>
                ...
                Yoco's PCI DSS compliant infrastructure with 3D Secure authentication.
              </p>
            </section>
          ...
          <div className="flex-1 overflow-y-auto p-6 space-y-6 text-gray-300 text-sm leading-relaxed">
            ...
            <section>
              ...
              <ul className="list-disc list-inside space-y-1 text-gray-400">
                <li>All payments are processed securely through Yoco, a registered South African payment gateway.</li>
                <li>We accept major credit and debit cards via Yoco.</li>
